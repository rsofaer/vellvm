   ...
   TLE_Definition {|
       ...
       df_instrs := (
                     {|
                       blk_id := (Anon 0%Z);
                       blk_phis := [];
                       blk_code := [(IId (Anon 1%Z), (INSTR_Op (OP_GetElementPtr (TYPE_Identified (ID_Local (Name "struct.Node"))) ((TYPE_Pointer (TYPE_Identified (ID_Local (Name "struct.Node")))),(EXP_Ident (ID_Local (Name "root")))) [((TYPE_I 32%N),(EXP_Integer (0)%Z)); ((TYPE_I 32%N),(EXP_Integer (2)%Z))] false)));
                   ...
                   {|
                     blk_id := (Name "left");
                     blk_phis := [];
                     blk_code := [(IId (Anon 5%Z), (INSTR_Op (OP_GetElementPtr (TYPE_Identified (ID_Local (Name "struct.Node"))) ((TYPE_Pointer (TYPE_Identified (ID_Local (Name "struct.Node")))),(EXP_Ident (ID_Local (Name "root")))) [((TYPE_I 32%N),(EXP_Integer (0)%Z)); ((TYPE_I 32%N),(EXP_Integer (0)%Z))] false)));
                   ...
                   {|
                     blk_id := (Name "right");
                     blk_phis := [];
                     blk_code := [(IId (Anon 9%Z), (INSTR_Op (OP_GetElementPtr (TYPE_Identified (ID_Local (Name "struct.Node"))) ((TYPE_Pointer (TYPE_Identified (ID_Local (Name "struct.Node")))),(EXP_Ident (ID_Local (Name "root")))) [((TYPE_I 32%N),(EXP_Integer (0)%Z)); ((TYPE_I 32%N),(EXP_Integer (1)%Z))] false)));
